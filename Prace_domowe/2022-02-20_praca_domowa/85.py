# Ćwiczenie 85
#
# Napisz program do wprowadzania studentów w zakresie informacji: ❑ imie, nazwisko, grupa
# ❑ Program ma przechowywać dane w pliku txt
# ❑ Funkcjonalność programu umożliwiać ma dodawanie, usuwanie,
# zmianę oraz pokazywanie listy studentów
# ❑ Usuwanie oraz zmiana może działać po nazwisku
# ❑ Program wyposażony jest w interaktywne menu (D-dodaj, P-pokaz, U-usuń, Z- zmień, Q-wyjście)
#
# * - szukanie podanej frazy po imieniu i nazwisku
# ❑ * - zaprojektuj mechanizm dodawania ocen dla każdego studenta wraz z wypisaniem średniej dla każdego z nich w opcji „P”
